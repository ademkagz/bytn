...
from fake_stake.base_test import Bytncoin_FakeStakeTest

class zBYTNwrappedSerialsTest(Bytncoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBYTNs..." % DENOM_TO_USE)
