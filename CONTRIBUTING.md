Contributing to Bytncoin Core
============================

The Bytncoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bytncoin-project/bytncoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bytncoin Core project, and is not to be
confused with overall Bytncoin Network Protocol consensus changes.

Whether a pull request is merged into Bytncoin Core rests with the project merge
...
Patches that change Bytncoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bytncoin consensus, it must have been
...
The project leader is the release manager for each Bytncoin Core release.
