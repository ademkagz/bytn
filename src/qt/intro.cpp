...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bytncoin Core"),
     ...
     * override -datadir in the bytncoin.conf file in the default data directory
     * (to be consistent with bytncoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
