...
/* Bytncoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bytncoin"
#define QAPP_ORG_DOMAIN "bytncoin.org"
#define QAPP_APP_NAME_DEFAULT "Bytncoin-Qt"
#define QAPP_APP_NAME_TESTNET "Bytncoin-Qt-testnet"
