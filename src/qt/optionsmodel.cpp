...
// Wallet
    ...
    if (settings.contains("nAnonymizeBytncoinAmount"))
        SoftSetArg("-anonymizebytncoinamount", settings.value("nAnonymizeBytncoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bytncoin.cpp during shotdown to also remove the window positions
