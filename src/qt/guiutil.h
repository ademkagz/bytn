...
/** Utility functions used by the Bytncoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bytncoin addresses in monospace font
...
// Parse "bytncoin:" URI into recipient object, return true on successful parsing
