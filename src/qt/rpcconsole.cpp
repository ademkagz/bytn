                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBYTNPathCustom = GetArg("-zbytnbackuppath", "");
    ...
    if(!strzBYTNPathCustom.empty()) {
        ui->wallet_customzbytnbackuppath->setText(QString::fromStdString(strzBYTNPathCustom));
        ui->wallet_customzbytnbackuppath_label->setVisible(true);
        ui->wallet_customzbytnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBYTNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bytncoin RPC console.") + "<br>" +
