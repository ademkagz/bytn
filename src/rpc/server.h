...
/**
 * Bytncoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZbytnSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbytnseed(const UniValue& params, bool fHelp);
extern UniValue getzbytnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbytn(const UniValue& params, bool fHelp);
extern UniValue dzbytnstate(const UniValue& params, bool fHelp);
