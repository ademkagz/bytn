...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bytncoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Bytncoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bytncoin features */
        {"bytncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bytncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bytncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bytncoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bytncoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bytncoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bytncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bytncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bytncoin", "startmasternode", &startmasternode, true, true, false},
        {"bytncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bytncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bytncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bytncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bytncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bytncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bytncoin", "preparebudget", &preparebudget, true, true, false},
        {"bytncoin", "submitbudget", &submitbudget, true, true, false},
        {"bytncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bytncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bytncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bytncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bytncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bytncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bytncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bytncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bytncoin", "mnsync", &mnsync, true, true, false},
        {"bytncoin", "spork", &spork, true, true, false},
        {"bytncoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbytnseed", &getzbytnseed, false, false, true},
        {"zerocoin", "setzbytnseed", &setzbytnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbytn", &searchdzbytn, false, false, true},
        {"zerocoin", "dzbytnstate", &dzbytnstate, false, false, true},
...
{
    return "> bytncoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19837/\n";
}
