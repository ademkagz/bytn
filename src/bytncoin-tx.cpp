...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bytncoin Core bytncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bytncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bytncoin transaction") + "\n" +
                               "  bytncoin-tx [options] -create [commands]   " + _("Create hex-encoded bytncoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bytncoin transaction
