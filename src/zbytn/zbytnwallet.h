...
#ifndef Bytncoin_ZBYTNWALLET_H
#define Bytncoin_ZBYTNWALLET_H
...
public:
    CzBYTNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBYTN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBYTN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
