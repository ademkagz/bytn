...
#ifndef Bytncoin_ZBYTNTRACKER_H
#define Bytncoin_ZBYTNTRACKER_H
...
public:
    CzBYTNTracker(std::string strWalletFile);
    ~CzBYTNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBYTNWallet* zBYTNWallet = NULL);
