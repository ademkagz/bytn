...
RESOURCES += src/qt/bytncoin.qrc src/qt/bytncoin_locale.qrc

TRANSLATIONS += src/qt/locale/bytncoin_bg.ts \
                src/qt/locale/bytncoin_de.ts \
                src/qt/locale/bytncoin_en.ts \
                src/qt/locale/bytncoin_es.ts \
                src/qt/locale/bytncoin_fi.ts \
                src/qt/locale/bytncoin_fr.ts \
                src/qt/locale/bytncoin_it.ts \
                src/qt/locale/bytncoin_ja.ts \
                src/qt/locale/bytncoin_pl.ts \
                src/qt/locale/bytncoin_pt.ts \
                src/qt/locale/bytncoin_ru.ts \
                src/qt/locale/bytncoin_sk.ts \
                src/qt/locale/bytncoin_sv.ts \
                src/qt/locale/bytncoin_vi.ts \
                src/qt/locale/bytncoin_zh_CN.ts \
                src/qt/locale/bytncoin_zh_TW.ts
